...
FACTION_FILE_MAPPING = {
    # Space Marines и все под-фракции
    ...
    "black templars": "space_marines",
    "dark angels": "space_marines",
    "blood angels": "space_marines",
    "space wolves": "space_marines",
    "deathwatch": "space_marines",
    "grey knights": "grey_knights",
    # Chaos Space Marines
    "heretic astartes": "chaos_space_marines",
